<template>
    <div style="padding: 55px 380px">
        <el-form ref="form" :model="form" :rules="rules" label-width="100px" size="normal" >
            <el-form-item prop="managerName" label="用户名" >
                <el-input :prefix-icon="Avatar" v-model="form.managerName" style="width: 320px" disabled/>
            </el-form-item>
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                form:{
                    managerName: sessionStorage.getItem("managerName").replace('"','').replace('"',''),
                    password:'',
                    confirm:'',
                },
                rules: {
